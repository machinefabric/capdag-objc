...
func test6307_PressureAndKill(host: CartridgeHost, writer: FrameWriter, reader: FrameReader) -> Bool {
    let percent = 90
...
let success = test6307_PressureAndKill(host: host, writer: writer, reader: reader)
