...
class CborRelayTests: XCTestCase {
    ...
    func test410_masterReceivesUpdatedRelayNotify() throws {
        ...
        // Initial RelayNotify
        let initialManifest = "{\"caps\":[{\"urn\":\"cap:effect=none\",\"title\":\"Identity\",\"aliases\":[\"identity\"]},{\"urn\":\"cap:in=media:;a;out=media:\",\"title\":\"A\",\"aliases\":[\"a\"]}]}".data(using: .utf8)!
        ...
        let updatedManifest = "{\"caps\":[{\"urn\":\"cap:effect=none\",\"title\":\"Identity\",\"aliases\":[\"identity\"]},{\"urn\":\"cap:in=media:;a;out=media:\",\"title\":\"A\",\"aliases\":[\"a\"]},{\"urn\":\"cap:in=media:;b;out=media:\",\"title\":\"B\",\"aliases\":[\"b\"]}]}".data(using: .utf8)!
